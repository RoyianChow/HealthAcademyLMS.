// Running this script transfers courses from an admin account to "archive-admin-account".
...
async function safelyTransferCourses() {
  const oldAdminId = "8ACOQK2lYrBvzKNDJWQkFcbDE0wPO439"; // Replace with the actual admin user ID you want to transfer courses from
